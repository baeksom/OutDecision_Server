...
public class CustomOAuth2UserService implements OAutRh2UserService<OAuth2UserRequest, OAuth2User> {
        ...
        public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
            ...
            OAuth2User oAuth2User = oAuth2UserService.loadUser(userequest);
