# OutDecision_Server
OutDecision - 결정 장애들을 위한 고민 투표 플랫폼, 결정잘해(Outdecision) 🤔 Server Repo.
...
: 오늘날 결정을 잘 내리지 못하는 사람들이 흔히 ‘결정 장애를 가지고 있다’는 표현을 자주 사용하곤 합니다. 이러한 사소한 고민을 여러 사람의 의견을 듣고 결정을 내리는데 참고하기 위해 고민을 올리는 커뮤니티 플랫폼을 고안했습니다. 이 플랫폼을 통해 크고 작은 고민에 대해 의견을 교류하면서 보다 합리적인 결정을 내릴 수 있는 것이 목표입니다. 결정 장애 키워드에서 착안하여 ‘결정잘해’로 이름을 지었습니다.
